...
public class AdultCinemaCalculatorImpl implements CinemaCalculator {

  private final TicketPriceService ticketPriceService;

  public AdultCinemaCalculatorImpl(TicketPriceService ticketPriceService) {
  ...
  public TicketResponseDTO calculateTicket(TicketRequest ticketRequest) {
    ...
    return TicketResponseDTO.builder()
        ...
        .totalTickets(ticketRequest.noOfTickets()).totalSeats(ticketRequest.noOfTickets())
        .build();
